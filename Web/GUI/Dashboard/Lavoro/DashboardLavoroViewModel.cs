    ...
    public class DashboardLavoroViewModel : TemplateViewModel<DashboardLavoro, DashboardLavoroItem>
    {
        ...
        private IQueryable<DashboardLavoro> QueryDashboards()
        {
            try
            {
                ...
                var dashboardCommittente = new DashboardLavoro("Committenti", "CT", "Specifica i committenti per le commesse inserite nel sistema, definisci gli importi attribuiti ai vari SAL...", "Images.dashboard.committente.png", "", typeof(CommittenteView));
