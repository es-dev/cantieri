    ...
    public class DashboardViewModel: TemplateViewModel<Dashboard, DashboardItem>
    {
        ...
        private IQueryable<Dashboard> QueryDashboards()
        {
            try
            {
                ...
                var dashboardReports = new Dashboard("Reports lavori", "RPT", "Crea un report di bilancio economico o effettua un controllo amministrativo per tenere sotto controllo le tue commesse, i tuoi committenti e i tuoi lavori...", "Images.dashboard.reportjob.png", "", typeof(ReportJobView));
