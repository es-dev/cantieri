    ...
    public class DashboardViewModel: TemplateViewModel<Dashboard, DashboardItem>
    {
        ...
        private IQueryable<Dashboard> QueryDashboards()
        {
            try
            {
                ...
                var dashboardAgenda = new Dashboard("Agenda e scadenzario", "AG-SCA", "Organizza il tuo lavoro in una comoda e pratica agenda digitale. Visualizza le scadenze imminenti e i pagamenti effettuati. Pianifica i tuoi lavori e gli stati di avanzamento lavori...", "Images.dashboard.agenda.png", "", typeof(AgendaView), false);
