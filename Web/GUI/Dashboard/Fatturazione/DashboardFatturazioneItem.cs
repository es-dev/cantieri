...
{
	public partial class DashboardFatturazioneItem : TemplateItem
	{
        public DashboardFatturazioneItem()
        {
            InitializeComponent();
        }
        ...
        public override void BindView(object model)
        {
            try
            {
                if (model != null)
                {
                    var objDto = (DashboardFatturazione)model;
        ...
        private void DashboardFatturazioneItem_ItemClick(IItem item)
        {
            try
            {
                if (item != null)
                {
                    var objDto = (DashboardFatturazione)item.Model;
                    if (objDto != null)
                    {
