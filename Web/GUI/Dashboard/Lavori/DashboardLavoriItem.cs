...
{
	public partial class DashboardLavoriItem : TemplateItem
	{
        public DashboardLavoriItem()
        {
            InitializeComponent();
        }
        ...
        public override void BindView(object model)
        {
            try
            {
                if (model != null)
                {
                    var objDto = (DashboardLavori)model;
        ...
        private void DashboardLavoriItem_ItemClick(IItem item)
        {
            try
            {
                if (item != null)
                {
                    var objDto = (DashboardLavori)item.Model;
                    if (objDto != null)
                    {
