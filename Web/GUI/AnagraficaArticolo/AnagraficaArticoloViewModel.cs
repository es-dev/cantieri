    ...
    public class AnagraficaArticoloViewModel : Library.Template.MVVM.TemplateViewModel<AnagraficaArticoloView, AnagraficaArticoloItem, AnagraficaArticoloModel, AnagraficaArticoloDto>
    {
        ...
        public override void Load(int skip, int take, string search=null, object advancedSearch=null, OrderBy orderBy=null)
        {
            try
            {
                ...
                var objs = wcf.LoadAnagraficheArticoli(skip, take, search, advancedSearch, orderBy);
                Load(objs);
            }
            catch (Exception ex)
            {
        ...
        public override int Count(string search = null,  object advancedSearch=null)
        {
            ...
            {
                var wcf = new WcfService.Service();
                var count = wcf.CountAnagraficheArticoli(search, advancedSearch);
                return count;
            }
            catch (Exception ex)
            {
        ...
        internal IEnumerable<AnagraficaArticoloDto> ReadArticoli(AziendaDto azienda)
        {
            try
            {
                var wcf = new WcfService.Service();
                var objs = wcf.ReadAnagraficheArticoli(azienda);
                return objs;
            }
            catch (Exception ex)
            {
